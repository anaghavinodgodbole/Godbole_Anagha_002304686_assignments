...
//        txtBankName.setEnabled(false);
    ...
    private void txtWorkAddrPhoneNumberActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtWorkAddrPhoneNumberActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txtWorkAddrPhoneNumberActionPerformed
...
//        homeAddress.setPhoneNumber(txtHomeAddrPhoneNumber.getText());
//  
//        Address workAddress = p.getWorkAddress();
//        workAddress.setStreetAddress( txtWorkAddrStAddr.getText());
//        workAddress.setUnitNumber( txtWorkAddrStAddr.getText());
//        workAddress.setCity(txtWorkAddrStAddr.getText());
//        workAddress.setState(txtWorkAddrStAddr.getText());
//        workAddress.setZipCode(txtWorkAddrStAddr.getText());
//        workAddress.setPhoneNumber(txtWorkAddrStAddr.getText());
//        
//        
//        // Try to parse height input
//        try {
...
//                || height <= 0
//                || gender == '\0'
//                || homeAddress.getStreetAddress().isBlank()
//                || homeAddress.getUnitNumber().isBlank()
//                || homeAddress.getCity().isBlank()
//                || homeAddress.getState().isBlank()
//                || homeAddress.getZipCode().isBlank()
//                || homeAddress.getPhoneNumber().isBlank()
//                || workAddress.getStreetAddress().isBlank()
//                || workAddress.getUnitNumber().isBlank()
//                || workAddress.getCity().isBlank()
//                || workAddress.getState().isBlank()
//                || workAddress.getZipCode().isBlank()
//                || workAddress.getPhoneNumber().isBlank()) {
...
//       }
    ...
    private void txtWorkUnitNumberActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtWorkUnitNumberActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txtWorkUnitNumberActionPerformed

    private void txtWorkAddrStAddrActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtWorkAddrStAddrActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txtWorkAddrStAddrActionPerformed

    private void txtHomeAddrCityActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtHomeAddrCityActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txtHomeAddrCityActionPerformed

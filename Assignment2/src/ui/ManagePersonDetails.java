...
public class ManagePersonDetails extends javax.swing.JPanel {
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {                                          
        ...
        if(selectedRow >= 0){
            ...
            int dialogResult = JOptionPane.showConfirmDialog(null, "Are you sure you want to delete theselected row", "Warning", JOptionPane.WARNING_MESSAGE);
            if(dialogResult == JOptionPane.YES_OPTION){
                //Person selectedPerson = (Person) tblPerson.getValueAt(selectedRow, 0);
                System.out.println(tblPerson.getValueAt(selectedRow, 0));
                Person selectedPerson = (Person) tblPerson.getValueAt(selectedRow, 0);
                personDirectory.deletePerson(selectedPerson);
                populateTable();
            }
        }else{
            JOptionPane.showConfirmDialog(null, "Please select a person from the list", "Warning", JOptionPane.WARNING_MESSAGE);
        }
    }                                         
